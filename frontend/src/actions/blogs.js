import { DELETE_BLOGS, GET_BLOGS, ADD_BLOGS, UPDATE_BLOGS, LIKE_BLOGS, UNLIKE_BLOGS } from "./types";
...
// Like Blogs
export const likeBlogs = (id, blog) => (dispatch, getState) => {
  axios
    .patch(
...
// Unlike Blogs
export const unlikeBlogs = (id, blog) => (dispatch, getState) => {
  axios
    .patch(
        `http://localhost:8000/api/blogs/${id}/`, 
        blog,
